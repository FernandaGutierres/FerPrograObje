"""Importamos librerias para realizar nuestro diseño de interfar"""

import tkinter as tk
from tkinter import messagebox


#Creamos nuestra clase llamado TodoApp
...
class TodoApp:
    ...
    def __init__(self, root):
        ...
        self.root.title("Gestor de Tareas de Fernanda Gutierres")
        ...
        self.add_button = tk.Button(button_frame, text="Añadir", command=self.add_task, bg="green", fg="white",
        ...
        self.complete_button = tk.Button(button_frame, text="Marcar", command=self.mark_completed, bg="green",
        ...
        self.delete_button = tk.Button(button_frame, text="Eliminar", command=self.delete_task, bg="green", fg="white",
                                       borderwidth=3, relief="solid")
